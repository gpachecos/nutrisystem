...
<body class="bg">
	<div class="container">
		...
		<h3 class="text-center"><strong>Hábitos Alimentares</strong></h3>
		...
		<table class="table table-bordered table-striped">
			<thead>
				<tr>
					<th>Hábitos Alimentares</th>
				</tr>
				<tr>
					<td>Suplementos</td></td>
					<td>Alergia</td>
					<td>Intolerância</td>
					<td>Aversão</td>
				</tr>
			...
			<?php
				...
				{
					//recuperar as variaveis
					$suplementos	= $linha->suplementos;
					$alergia		= $linha->alergia;
					$intolerancia	= $linha->intolerancia;
					$aversao		= $linha->aversao;
