...
<div class="container">
	<div class="coluna">
		<h1 class="float-left">Avaliação Antropométrica</h1>
		...
		<h5>Avaliação Antropométrica</h5>
		<form name="relatorio" method="post" action="relatorios/relAvaliacaoAntropometrica.php" target="_blank">
			<div class="row">
			<div class="col-4">
