	...
	<div class="container">
		...
		<table class="table table-bordered table-striped">
			...
			<?php
				...
				{
					//recuperar as variaveis
					$usomedicamentos		= $linha->usomedicamentos;
					$descmedicamentos		= $linha->descmedicamentos;
					$horariomedicamentos	= $linha->horariomedicamentos;
					$historicofamiliar		= $linha->historicofamiliar;

					//mostrar os dados dentro da linha da tabela (tr)
					echo "<tr>
							<td>$usomedicamentos</td>
							<td>$descmedicamentos</td>
							<td>$horariomedicamentos</td>
							<td>$historicofamiliar</td>
						</tr>";
				}
			?>
		</table>
